/**
 * Login Form Handler
 * Manages customer login form interactions, validation, and communication with the server.
 */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (!loginForm || !usernameOrEmailInput || !passwordInput || !submitButton) {
            console.error('Login: Required form elements not found.');
            return;
        }
        ...
        loginForm.addEventListener('submit', async function (e) {
            ...
            try {
                var response = await fetch('/JCart/customer/login', {
                    method: 'POST',
                ...
                if (response.ok) {
                    ...
                    var userName = usernameOrEmail.includes('@')
